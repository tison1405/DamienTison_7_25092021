exports.createPost = (req, res, next) => {
    const post = [[req.body.users_id, req.body.fichier, req.body.commentaire, req.body.users_photo,0]];
    var sql = "INSERT INTO forummulti ( users_id, fichier, commentaire, users_photo, publication) VALUES ?";
